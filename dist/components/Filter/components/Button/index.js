...
exports.Button = (0, react_1.forwardRef)(({ icon: IconCustom, children, isOpen, ...props }, ref) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("button", { ...props, ref: ref, className: (0, concatStyles_1.concatStyles)([
        ...
        ]), children: [children, IconCustom ? (0, jsx_runtime_1.jsx)(IconCustom, {}) : null, IconCustom ? (0, jsx_runtime_1.jsx)(IconCustom, {}) : (0, jsx_runtime_1.jsx)(Icon_1.Icon, { name: 'chevron-down', size: 1 }), (0, jsx_runtime_1.jsx)(Icon_1.Icon, { name: 'chevron-down', size: 1 })] }));
});
