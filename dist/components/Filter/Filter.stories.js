...
const SortFilter = () => {
    return ((0, jsx_runtime_1.jsxs)(_1.Filter.Container, { children: [(0, jsx_runtime_1.jsx)(_1.Filter.Button, { icon: () => (0, jsx_runtime_1.jsx)(Icon_1.Icon, { name: "sort", size: 1 }), children: "Ordem" }), (0, jsx_runtime_1.jsx)(_1.Filter.Sort, { getLabel: (item) => item.label, getValue: (item) => item.value, field: "orderByField", options: [
