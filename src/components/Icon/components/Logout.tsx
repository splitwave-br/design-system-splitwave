...
const Logout = () => {
  return (
    ...
    >
      ...
      />
      <path
        d='M17.5001 9.99996H9.16675M17.5001 9.99996C17.5001 9.41646 15.8382 8.32623 15.4167 7.91663M17.5001 9.99996C17.5001 10.5835 15.8382 11.6737 15.4167 12.0833'
        stroke='currentColor'
        strokeWidth='1.5'
        strokeLinecap='round'
