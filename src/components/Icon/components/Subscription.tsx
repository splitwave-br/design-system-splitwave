const Subscription = () => {
  return (
    ...
    >
      ...
      />
      <path
        d="M10 8C10 5.78907 10 4.68361 10.7019 3.94556C10.8141 3.82752 10.9379 3.71834 11.0716 3.61929C11.9081 3 13.1609 3 15.6667 3H16.3333C18.8391 3 20.0919 3 20.9284 3.61929C21.0621 3.71834 21.1859 3.82752 21.2981 3.94556C22 4.68361 22 5.78907 22 8C22 10.2109 22 11.3164 21.2981 12.0544C21.1859 12.1725 21.0621 12.2817 20.9284 12.3807C20.1696 12.9425 19.0683 12.9947 17 12.9995"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
